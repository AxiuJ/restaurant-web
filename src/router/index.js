...
export const asyncRouterMap = [

 {
    ...
    hidden:false,
    children: [
      {path: '/wz',name: '人员管理',icon:"speedometer",component: wz},
      {path: '/menus2',name: '菜单管理',icon:"android-list",component: _import('menus2')},
      {path: '/datatree',name: '数据分析',icon:"android-list",component: _import('datatree')},
      {path: '/ordertable',name: '订单管理',icon:"android-list",component: _import('ordertable')},
    ]
  },

   {
    path: '/home1',
    redirect: '/home1/orderdishes',
    name: '首页2',
    component: Full2,
    hidden:false,
    children: [

     {path: '/home1/orderdishes',name: '点单系统',icon:'thumbsup',component: _import('orderdishes')},
